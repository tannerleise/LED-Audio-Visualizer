//NOTE: Most of this code is not my own, I honestly cannot remember where the logic code was obtained. However, if I am able to refind
...
#define OCT_NORM 0 // Don't normalize octave intensities by number of bins
